...
public class DbConn {
    ...
    public DbConn() {
        ...
        //String dbAndPass = "SP20_3344_tun49199?user=tun49199&password=uoyaejee";
    ...
    private boolean isTemple() {
        ...
        try {
            ...
            if (hostName.endsWith("temple.edu")) {
                temple = true;
                //System.out.println("************* Running from Temple, so using cis-linux2 for db connection. hostName is " + hostName);
            } else {
